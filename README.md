...
--> Usuário (ONG que deseja estar disponibilizando animais para adoção) deverá ser capaz de adentrar em nosso site para realizar um cadastro que será confirmado após análise dos documentos, os primeiros dados que a ONG deve estar informando é: CNPJ, NOME FANTASIA, NOME, E-MAIL, TELEFONE, ESTADO, CIDADE E SE POSSUI CERTIFICAÇÕES // Após o cadastro ser confirmado pela nossa central a ONG poderá ter acesso a um formulário de cadasto dos animais onde será obrigado a infomar TAMANHO, PESO, IDADE, RAÇA, SEXO E NOME CASO O ANIMAL POSSUA. Após estes processos a ONG também terá acesso a uma área de mensagens, a qual estará respondendo aos usuários que pretendem adotar com mais infomações e assim combinando o processo de conhecer o animal e ir até o local para retirá-lo
